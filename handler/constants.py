...
DISCOUNT = '10'
"""Вставка в плейсхолдер маски промо текста по умолчанию (процент скидки)."""

GEO = 'Москве и области'
"""
Вставка в плейсхолдер маски промо текста
по умолчанию (геоданные), (учитывать падеж!).
"""

PRICE = '6000'
"""
Вставка в плейсхолдер маски промо текста по
умолчанию (цена, с которой начинается бесплатная доставка).
"""
